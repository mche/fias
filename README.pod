...
B<"SHORTNAME"> - номер версии

B<"FORMALNAME"> - описание версии
...
=head3 Поиск адреса - fias.search_formalname(text[])

На входе: массив образцов поиска, B<ВАЖНО> - от малого адреса к большему.

Возвращает: массивы колонок ("AOGUID" uuid[], "PARENTGUID" uuid[], "AOLEVEL" int2[], "FORMALNAME" text[], "SHORTNAME" varchar(10)[],  id int[]) и условные веса (weight int2, _weight int2).
