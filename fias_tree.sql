...
IS 'Возвращает дерево (список взаимосвязанных строк) 
     ...
     SELECT * FROM fias.f_AddressObjectTree(''719b789d-2476-430a-89cd-3fedc643d821'',51) ORDER BY "AOLEVEL";
     SELECT * FROM fias.f_AddressObjectTree(''719b789d-2476-430a-89cd-3fedc643d821'') ORDER BY "AOLEVEL";
     ';
